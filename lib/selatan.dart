                ...
                children: <Widget>[
                  ...
                  child: new Material(
                    child: new InkWell(
                      ...
                      child: new Image.asset('assets/kbs.png', fit: BoxFit.contain,),
                    ),
                  ))
                ],
              ),
                ...
                children: <Widget>[
                  ...
                  child: new Material(
                    child: new InkWell(
                      ...
                      child: new Image.asset('assets/hm.png',),
                    ),
                  ))
                ],
              ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: new ListView(
        children: <Widget>[
          new Container(
            child: new Image.asset('assets/kbs.png', fit: BoxFit.cover,),
          ),
          new Container(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: new ListView(
        children: <Widget>[
          new Container(
            child: new Image.asset('assets/hm.png', fit: BoxFit.cover,),
          ),
          new Container(
            padding: new EdgeInsets.all(8.0),
            child: new Card(
